...
{
    use SoftDeletes;
    protected $table = "course_module_classes";
    protected $guarded = [];
    ...
    {
        return $this->belongsTo(\App\Modules\Management\CourseManagement\CourseModule\Models\Model::class, 'course_modules_id', 'id');
    }
}