<template>
    <div class="oursemilestone-create">
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    মাইলস্টোন তৈরি - API কল পরে যোগ করা হবে। এটি একটি প্রাথমিক টেমপ্লেট।
                </div>
...
export default {
    ...
    mounted() {
        console.log('CourseMilestoneCreate component mounted');
    },
};
</script>

<style scoped>
.oursemilestone-create {
    max-width: 100%;
}
