<template>
    <div class="oursejobposition-all">
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    সব জব পজিশন - API কল পরে যোগ করা হবে। এটি একটি প্রাথমিক টেমপ্লেট।
                </div>
...
export default {
    ...
    mounted() {
        console.log('CourseJobPositionAll component mounted');
    },
};
</script>

<style scoped>
.oursejobposition-all {
    max-width: 100%;
}
