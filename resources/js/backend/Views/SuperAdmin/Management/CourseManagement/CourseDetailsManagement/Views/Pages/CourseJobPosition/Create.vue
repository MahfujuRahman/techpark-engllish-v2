<template>
    <div class="oursejobposition-create">
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    জব পজিশন তৈরি - API কল পরে যোগ করা হবে। এটি একটি প্রাথমিক টেমপ্লেট।
                </div>
...
export default {
    ...
    mounted() {
        console.log('CourseJobPositionCreate component mounted');
    },
};
</script>

<style scoped>
.oursejobposition-create {
    max-width: 100%;
}
