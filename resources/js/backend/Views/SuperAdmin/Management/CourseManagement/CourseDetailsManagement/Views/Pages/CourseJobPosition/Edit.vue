<template>
    <div class="oursejobposition-edit">
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    জব পজিশন সম্পাদনা - API কল পরে যোগ করা হবে। এটি একটি প্রাথমিক টেমপ্লেট।
                </div>
...
export default {
    ...
    mounted() {
        console.log('CourseJobPositionEdit component mounted');
    },
};
</script>

<style scoped>
.oursejobposition-edit {
    max-width: 100%;
}
