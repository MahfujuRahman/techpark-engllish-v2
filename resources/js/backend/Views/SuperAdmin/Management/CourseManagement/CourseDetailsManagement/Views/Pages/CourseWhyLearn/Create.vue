<template>
    <div class="oursewhylearn-create">
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    নতুন কারণ যোগ করুন - API কল পরে যোগ করা হবে। এটি একটি প্রাথমিক টেমপ্লেট।
                </div>
...
export default {
    ...
    mounted() {
        console.log('CourseWhyLearnCreate component mounted');
    },
};
</script>

<style scoped>
.oursewhylearn-create {
    max-width: 100%;
}
